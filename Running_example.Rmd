...
```{r Step 3: compare replicate samples (on treatment replicates),warning=FALSE,fig.height = 6, fig.width = 6}
...
```{r Step 4: compare biological and replicate samples (on treatment replicates) after cqn normalization,warning=FALSE,fig.height = 6, fig.width = 6}
